---
title: "File Form 140 TDS returns"
sidebarTitle: "File Form 140"
description: "Validate and e-file Form 140 TDS returns with Sandbox's APIs, then download the filing receipt."
keywords:
  - file Form 140 using API
  - Form 140 TDS return filing
  - Form 26Q filing API
  - non-salary TDS return
  - quarterly TDS returns
---

This guide covers filing a regular non-salary TDS return for payments to residents using a prepared Form 140 text file. Form 140 replaces Form 26Q. See the [Income Tax Department's Form 140 FAQs](https://www.incometaxindia.gov.in/documents/d/guest/form-140-faqs) for the form's requirements.
...
- Prepare the Form 140 TXT file for your TAN, tax year, and quarter. You can use the [TDS Reports API](/api-reference/tds/reports/tds-reports/endpoints/submit_job) to generate it.
...
<Steps>
  ...
  <Step title="Request the CSI OTP" titleSize="h3">
    ...
    Call [Generate CSI OTP](/api-reference/tds/compliance/download-csi/endpoints/generate_otp) with the TAN, mobile number, and challan date range.
...
<div id="generate-form-16a-optional" />

After TRACES processes the Form 140 statement and makes the certificates available, follow the [Form 131 certificate guide](/recipes/tds/form-131/generate-form-131-certificates).
