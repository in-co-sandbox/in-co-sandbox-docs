...
description: "Generate Form 131 certificates, formerly Form 16A, with Sandbox's API. Follow cURL examples to create a TRACES job and download certificate PDFs in ZIP files."
keywords:
  - Form 131
