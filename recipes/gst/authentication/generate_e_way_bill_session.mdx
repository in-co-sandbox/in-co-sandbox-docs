...
<Steps>
  ...
  <Step title="Authenticate with E-Way Bill API" stepNumber={2} titleSize="h2">
    ...
    <Warning>
      **Prerequisites:** You must have API credentials created on the E-Way Bill portal to use this endpoint. If you haven't created them yet, follow the steps to [create API credentials](/api-reference/gst/compliance/guides/e-way-bill/authentication/create_api_credentials).
    </Warning>
  </Step>
</Steps>