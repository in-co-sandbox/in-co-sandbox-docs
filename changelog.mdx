...
<Update label="July 7th, 2026" tags={["Feature"]}>
  ...
  **Key Behaviour**
  ...
  For general caching guidance, please refer to our [**Response Caching**](https://developer.sandbox.co.in/docs/response-caching#x-accept-cache-header) documentation.
</Update>
