...
<div class="hidden" data-table-of-contents="bottom">
  ...
  <ul>
    <li><a href="/api-reference/authentication">Authentication Overview</a></li>
    <li><a href="/api-reference/rate-limits">Rate Limits</a></li>
    <li><a href="/api-reference/integration-troubleshooting/overview-ts">Integration Troubleshooting</a></li>
  </ul>
</div>
