...
<CardGroup cols={2}>
  ...
  <Card title="IT APIs" icon="/static/svg/workload-icons/IT.svg" href="https://www.postman.com/in-co-sandbox/sandbox-api/collection/vi869sx/income-tax-calculator">
