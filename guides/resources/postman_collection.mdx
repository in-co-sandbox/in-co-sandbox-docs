...
<CardGroup cols={2}>
  <Card title="KYC APIs" icon="credit-card" href="https://www.postman.com/in-co-sandbox/sandbox-api/collection/t61ohmi/kyc">
    Instant identity verification for secure and scalable growth.
  </Card>
  <Card title="GST APIs" icon="credit-card" href="https://www.postman.com/in-co-sandbox/sandbox-api/collection/tdybepo/gst-analytics">
    Managing a business is complex, but GST doesn’t have to be.
  </Card>
  <Card title="TDS APIs" icon="credit-card" href="https://www.postman.com/in-co-sandbox/sandbox-api/collection/kxuf3b1/tds-analytics">
    Deduct accurately, convert data for filing, and submit returns on time.
  </Card>
  <Card title="IT APIs" icon="credit-card" href="https://www.postman.com/in-co-sandbox/sandbox-api/collection/vi869sx/income-tax-calculator">
