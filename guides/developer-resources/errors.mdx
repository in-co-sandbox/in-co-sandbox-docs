---
title: "Errors"
description: "Understand error responses, http status codes, and how to handle errors in Sandbox APIs."
keywords: ["errors", "error codes", "http status", "troubleshooting", "error handling"]
---
