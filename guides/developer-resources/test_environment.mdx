...
<Steps>
  <Step title="Fork the Authentication collection with environment" stepNumber={1} titleSize="h3">
    ...
    <Frame>
      <video controls width="100%">
        <source src="https://d2tyfzp2nc38wx.cloudfront.net/step_1_4056a278c8.mp4" type="video/mp4" />
  ...
  <Step title="Populate the environment" titleSize="h3">
    ...
    <Frame>
      <video controls width="100%">
        <source src="https://d2tyfzp2nc38wx.cloudfront.net/step_2_984d3e7a06.mp4" type="video/mp4" />
        Your browser does not support the video tag.
      </video>
    </Frame>
  ...
  <Step title="Get the access token by hitting Authenticate" titleSize="h3">
    ...
    <Frame>
      <video controls width="100%">
        <source src="https://d2tyfzp2nc38wx.cloudfront.net/step_3_95862e876a.mp4" type="video/mp4" />
        Your browser does not support the video tag.
      </video>
    </Frame>
...
<Step title="Fork the product collection" titleSize="h3">
    ...
    <Frame>
      <video controls width="100%">
        <source src="https://d2tyfzp2nc38wx.cloudfront.net/step_4_6c7da32739.mp4" type="video/mp4" />
        Your browser does not support the video tag.
      </video>
    </Frame>
  ...
  <Step title="Try out endpoint examples for mock responses" titleSize="h3">
    ...
    <Frame>
      <video controls width="100%">
        <source src="https://d2tyfzp2nc38wx.cloudfront.net/step_5_355a2e29fc.mp4" type="video/mp4" />
        Your browser does not support the video tag.
      </video>
    </Frame>
