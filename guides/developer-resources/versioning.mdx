---
title: "Versioning"
description: "Learn how Sandbox uses semantic versioning and how to specify API versions in your requests."
keywords: ["versioning", "semantic versioning", "API version", "deprecation", "backward compatibility"]
---
