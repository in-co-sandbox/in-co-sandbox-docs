---
title: "Rate limits"
description: "Understand API rate limits for test and production environments and how to handle rate limiting."
keywords: ["rate limit", "throttling", "429", "API limits", "requests per second"]
---
...
| **Environment** | **Host url**                     | **Requests per second** |
| :-------------- | :------------------------------- | :---------------------- |
| Test            | `https://test-api.sandbox.co.in` | 25                      |
| Production      | `https://api.sandbox.co.in`      | 100                     |
