...
[View an example workbook for TDS Form 140.](https://sheet-tools.quicko.org.in/sheet-visualiser?schema_url=https://raw.githubusercontent.com/in-co-sandbox/in-co-sandbox-docs/refs/heads/main/data/tds/reports/forms/form140_workbook.schema.json&data_url=https://raw.githubusercontent.com/in-co-sandbox/in-co-sandbox-docs/refs/heads/main/data/tds/reports/forms/form140_workbook.data.json)

In the preceding workbook, there are four separate sheets, each containing different types of data. The same data in JSON format would look like this.
