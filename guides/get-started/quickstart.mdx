...
<Steps>
  <Step title="Get your API credentials">
    ...
    - **Test environment**: Keys prefixed with `test` for development
    - **Live environment**: Keys prefixed with `live` for production
...
<CardGroup cols={2}>
  ...
  <Card title="Rate limits" icon="gauge-high" href="/guides/developer-resources/rate_limit">
