...
<CardGroup cols={2}>
  ...
  <Card title="Aadhaar" icon="shield-check" href="/api-reference/vrs/overview">
    Verify customer identities using Cashfree's identity verification solutions (PAN, Aadhaar, and more).
  </Card>

  <Card title="PAN" icon="credit-card" href="/api-reference/kyc/digilocker">
    Accept payments from customers through digital and in-person channels.
  </Card>

  <Card title="Bank" icon="building-columns" href="/api-reference/payouts/overview">
    Manage company finances through a unified dashboard.
  </Card>


  <Card title="Digilocker" icon="wallet" href="/api-reference/prepaid-payment-instruments/overview">
