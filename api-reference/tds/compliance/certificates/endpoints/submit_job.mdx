---
title: 'Create TDS or TCS certificate job'
description: "Create a certificate generation job for Form 130, 131, or 133 with a TAN and tax period. Retrieve the job ID to check its status."
keywords:
  - TDS certificate API
  - TCS certificate API
  - Form 130
