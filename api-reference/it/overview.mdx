...
<CardGroup cols={2}>
  <Card title="IT Recipes" href="/recipes/it/introduction" icon="book-open">
    Step-by-step guides for common income tax workflows.
  </Card>
  <Card title="Authentication" href="/api-reference/authenticate" icon="key">
    How to authenticate your API requests.
  </Card>
  <Card title="Error handling" href="/guides/developer-resources/errors" icon="triangle-exclamation">
    API error codes and troubleshooting.
  </Card>
  <Card title="Rate limits" href="/guides/developer-resources/rate_limits" icon="gauge">
...
<Card title="Income Tax" icon="/static/svg/workload-icons/IT.svg" href="https://sandbox.co.in/income-tax?utm_campaign=cta-banner&utm_source=in-co-sandbox-developer&utm_medium=direct&utm_content=api-reference-it-overview">
Pricing and feature overview for ITR filing and tax
calculation APIs.
</Card>
