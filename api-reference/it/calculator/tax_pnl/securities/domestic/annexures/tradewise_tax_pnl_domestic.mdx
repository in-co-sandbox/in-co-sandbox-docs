...
| Nature Of Transfer | `string` | Yes | See [Nature of Settlement](https://developer.sandbox.co.in/reference/annexures#annexure-2-nature-of-settlement) |
...
| Param | Type | Required | Description |
| :---- | :------- | :------- | :---------- |
| Nature Of Transaction | `string` | Yes | See [Nature of Settlement](https://developer.sandbox.co.in/reference/annexures#annexure-2-nature-of-settlement) |
...
| Label | `string` | No | See [Labels](https://developer.sandbox.co.in/reference/annexures#annexure-1-labels) |
...
| Nature Of Transfer | `string` | Yes | See [Nature of Transfer](https://developer.sandbox.co.in/reference/annexures#annexure-2-nature-of-settlement) |
| Transfer Value | `number` | Yes | Total trading amount |
...
| Param | Type | Required | Description |
| :---- | :------- | :------- | :---------- |
| Nature Of Transaction | `string` | Yes | See [Nature of Transfer](https://developer.sandbox.co.in/reference/annexures#annexure-2-nature-of-settlement) |
