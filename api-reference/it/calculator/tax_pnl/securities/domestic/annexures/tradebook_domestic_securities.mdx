...
| label | `string` | No | Refer to [label](/api-reference/it/calculator/tax_pnl/securities/domestic/annexures/labels) for allowed values |
...
| label | `string` | No | See [label](/api-reference/it/calculator/tax_pnl/securities/domestic/annexures/labels) for allowed values |
