...
The SDK integration follows a three-step process:

1. **Create a session** on your backend using the Create Session API
...
For backend-only integration with full control over the UI, use the [EntityLocker API](/api-reference/kyc/entitylocker/overview) instead.
