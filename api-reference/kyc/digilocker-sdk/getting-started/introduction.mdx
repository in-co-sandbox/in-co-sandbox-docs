---
title: "Introduction"
description: "Integrate DigiLocker document retrieval into your application with client-side SDKs"
---
...
For backend-only integration with full control over the UI, use the [DigiLocker API](/api-reference/kyc/digilocker/overview) instead.