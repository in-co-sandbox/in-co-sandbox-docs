...
| [Generate E-Way Bill PDF](/api-reference/gst/compliance/endpoints/e-way-bill/common/generate_e_way_bill_pdf) | GET | `/gst/compliance/e-way-bill/tax-payer/bill/{ewb_no}/pdf/generate` |
| [Generate E-Way Bill PDF by IRN](/api-reference/gst/compliance/endpoints/e-way-bill/common/generate_e_way_bill_pdf_by_irn) | GET | `/gst/compliance/e-way-bill/tax-payer/invoice/{irn}/pdf/generate` |
