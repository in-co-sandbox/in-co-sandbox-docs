...
To access e-Invoicing through APIs, you need to create API credentials on the E-Invoice portal. These credentials are used in the [E-Invoice Authentication API](https://developer.sandbox.co.in/reference/E-Invoice-authentication-api) to generate a 6-hour access token.
...
<Tip>
  **Next Steps:** Use the username and password you created in Step 5 to authenticate with the [E-Invoice Authentication API](https://developer.sandbox.co.in/reference/E-Invoice-authentication-api). These credentials will generate a 6-hour access token for making E-Invoice API requests.
</Tip>
