...
<CardGroup>
  <Card
    title="View GSTR-2B upload schema"
    icon="code"
    href="https://raw.githubusercontent.com/in-co-sandbox/in-co-sandbox-docs/refs/heads/main/data/gst/analytics/reconciliation/gstr_2b_upload.schema.json"
    arrow="true"
    horizontal
  >
  </Card>
