...
<CardGroup cols={3}>
  <Card title="Postman Collections" icon="book-bookmark" href="/guides/resources/postman_collection">
  ...
  <Card title="Help Centre" icon="life-ring" href="/guides/resources/help_centre">
